...
void EINT3_IRQHandler(void)
{
	...
	Chip_GPIOINT_SetIntFalling(LPC_GPIOINT, GPIOINT_PORT0, 0); //Deshabilito todas las int
...
//	}
	...
	if(!(sample_index %= SAMPLE_BUFFER_LENGHT))
	{
		...
		//Chip_ADC_SetBurstCmd(LPC_ADC, DISABLE);	//Deshabilito el canal y dejo de muestrear
